...
always @(posedge spi0_reset) begin: USBP_MYHDL_SPI0_TXFIFO_RTL_GUARD_BIT
    if (wb_clk) begin
        spi0_txFifo_gb <= 1'b0;
    end
    else begin
        ...
        else if (((spi0_txFifo_wp_p1 == spi0_txFifo_rp) && spi0_tx_fifo_wr)) begin
            spi0_txFifo_gb <= 1'b1;
        end
        else if (spi0_tx_fifo_rd) begin
            spi0_txFifo_gb <= 1'b0;
        end
    end
end

always @(posedge spi0_reset) begin: USBP_MYHDL_SPI0_TXFIFO_RTL_WP_REG
    if (wb_clk) begin
        spi0_txFifo_wp <= 0;
    end
    else begin
...
always @(posedge spi0_reset) begin: USBP_MYHDL_SPI0_TXFIFO_RTL_RP_REG
    if (wb_clk) begin
        spi0_txFifo_rp <= 0;
    end
    else begin
...
always @(posedge spi0_reset) begin: USBP_MYHDL_SPI0_TXFIFO_RTL_MEM
...
always @(spi0_txFifo_rp, spi0_txFifo_gb, spi0_txFifo_wp) begin: USBP_MYHDL_SPI0_TXFIFO_RTL_ASSIGNMENTS
...
always @(spi0_clkcnt, wb_rst) begin: USBP_MYHDL_SPI0_RTL_ASSIGNMENT
    spi0_reset <= (!wb_rst);
...
always @(posedge wb_clk) begin: USBP_MYHDL_SPI0_RTL_STATE_AND_MORE
...
always @(MISO, spi0_cr_msse, spi0_treg, spi0_SPSS, spi0__sck, spi0__ss, spi0_cr_loop) begin: USBP_MYHDL_SPI0_RTL_SPI_SIGS
    reg _miso_next;
    SCK <= spi0__sck;
...
always @(posedge wb_clk) begin: USBP_MYHDL_SPI0_RTL_CLK_DIV
    if ((spi0_cr_spe && (spi0_clkcnt != 0) && (spi0_state != 0))) begin
        ...
        else if ((spi0_SPXX == 1)) begin
            spi0_clkcnt <= 1;
        end
        else if ((spi0_SPXX == 2)) begin
            spi0_clkcnt <= 3;
        end
        else if ((spi0_SPXX == 3)) begin
            spi0_clkcnt <= 7;
        end
        else if ((spi0_SPXX == 4)) begin
            spi0_clkcnt <= 15;
        end
        else if ((spi0_SPXX == 5)) begin
            spi0_clkcnt <= 31;
        end
        else if ((spi0_SPXX == 6)) begin
            spi0_clkcnt <= 63;
        end
        else if ((spi0_SPXX == 7)) begin
            spi0_clkcnt <= 127;
        end
        else if ((spi0_SPXX == 8)) begin
            spi0_clkcnt <= 255;
        end
        else if ((spi0_SPXX == 9)) begin
            spi0_clkcnt <= 511;
        end
        else if ((spi0_SPXX == 10)) begin
            spi0_clkcnt <= 1023;
        end
        else if ((spi0_SPXX == 11)) begin
            spi0_clkcnt <= 2047;
        end
    end
end

always @(spi0_rx_fifo_full, spi0_tx_fifo_empty, spi0_rx_fifo_empty, spi0_SPCR, spi0_tx_fifo_full) begin: USBP_MYHDL_SPI0_RTL_BIT_ASSIGNMENTS
...
always @(posedge spi0_reset) begin: USBP_MYHDL_SPI0_RXFIFO_RTL_GUARD_BIT
    if (wb_clk) begin
        spi0_rxFifo_gb <= 1'b0;
    end
    else begin
        ...
        else if (((spi0_rxFifo_wp_p1 == spi0_rxFifo_rp) && spi0_rx_fifo_wr)) begin
            spi0_rxFifo_gb <= 1'b1;
        end
        else if (spi0_rx_fifo_rd) begin
            spi0_rxFifo_gb <= 1'b0;
        end
    end
end

always @(posedge spi0_reset) begin: USBP_MYHDL_SPI0_RXFIFO_RTL_WP_REG
    if (wb_clk) begin
        spi0_rxFifo_wp <= 0;
    end
    else begin
...
always @(posedge spi0_reset) begin: USBP_MYHDL_SPI0_RXFIFO_RTL_RP_REG
    if (wb_clk) begin
        spi0_rxFifo_rp <= 0;
    end
    else begin
...
always @(posedge spi0_reset) begin: USBP_MYHDL_SPI0_RXFIFO_RTL_MEM
...
always @(spi0_rxFifo_rp, spi0_rxFifo_gb, spi0_rxFifo_wp) begin: USBP_MYHDL_SPI0_RXFIFO_RTL_ASSIGNMENTS
...
always @(posedge wb_clk) begin: USBP_MYHDL_SPI0_REGFILE_RTL_RO_STOBES
...
always @(posedge wb_clk) begin: USBP_MYHDL_SPI0_REGFILE_RTL_WRITE_REG
    if ((!wb_rst)) begin
    ...
    else if ((spi0_regFile__wb_wr && spi0_regFile__wb_sel)) begin
        if ((wb_adr == 96)) begin
            spi0_rwRegisters[0] <= wb_dat_o;
        end
        else if ((wb_adr == 104)) begin
            spi0_rwRegisters[1] <= wb_dat_o;
        end
        else if ((wb_adr == 112)) begin
            spi0_rwRegisters[2] <= wb_dat_o;
        end
        else if ((wb_adr == 124)) begin
            spi0_rwRegisters[3] <= wb_dat_o;
        end
    end
end

always @(spi0_regFile__wb_sel, spi0_regFile__wb_do) begin: USBP_MYHDL_SPI0_REGFILE_RTL_READ
...
always @(posedge wb_clk) begin: USBP_MYHDL_SPI0_REGFILE_RTL_SELECTED
...
always @(posedge wb_clk) begin: USBP_MYHDL_SPI0_REGFILE_RTL_RW_STOBES
...
always @(posedge wb_clk) begin: USBP_MYHDL_SPI0_REGFILE_RTL_ACK
    if ((!wb_rst)) begin
...
always @(fifo_empty, spi0_rx_fifo_full, spi0_tx_fifo_empty, spi0_roRd[0], spi0_roRd[1], spi0_roRd[2], spi0_roRd[3], fifo_full, spi0_treg, spi0__fifo_wr, spi0_cr_wb_sel, spi0_rwWr[0], spi0_rwWr[1], spi0_rwWr[2], spi0_rwWr[3], spi0_tx_fifo_do, fifo_do, spi0__fifo_rd) begin: USBP_MYHDL_SPI0_RTL_FIFO_SEL
...
always @(posedge wb_clk) begin: USBP_MYHDL_GPIO0_RTL_WISHBONE_DATA_ADDR
    if ((wb_adr == (256 + 1))) begin
        g0_dat_i <= gpio0_llgpio;
    end
    else if ((wb_adr == 256)) begin
        g0_dat_i <= gpio0_ctrl;
    end
    else begin
        g0_dat_i <= 0;
...
always @(posedge wb_clk) begin: USBP_MYHDL_GPIO0_RTL_WISHBONE_REGISTERS
    if ((!wb_rst)) begin
        gpio0_ctrl <= 255;
        gpio0_line <= 0;
    end
...
always @(gpio0__gpio_i, gpio0_line, gpio0_mask, gpio0_ctrl) begin: USBP_MYHDL_GPIO0_RTL_GPIO_SELECT
    integer n;
...
always @(posedge wb_clk) begin: USBP_MYHDL_GPIO0_RTL_WISHBONE_ACK
    if ((!wb_rst)) begin
        g0_ack <= 1'b0;
    end
    else begin
...
always @(posedge wb_clk) begin: USBP_MYHDL_GPIO0_RTL_GPIO_REGISTER_INPUT
...
always @(posedge wb_clk) begin: USBP_MYHDL_GPIO1_RTL_WISHBONE_DATA_ADDR
    if ((wb_adr == (258 + 1))) begin
        g1_dat_i <= gpio1_llgpio;
    end
    else if ((wb_adr == 258)) begin
        g1_dat_i <= gpio1_ctrl;
    end
    else begin
        g1_dat_i <= 0;
...
always @(posedge wb_clk) begin: USBP_MYHDL_GPIO1_RTL_WISHBONE_REGISTERS
    if ((!wb_rst)) begin
        gpio1_ctrl <= 255;
        gpio1_line <= 0;
    end
...
always @(gpio1__gpio_i, gpio1_line, gpio1_mask, gpio1_ctrl) begin: USBP_MYHDL_GPIO1_RTL_GPIO_SELECT
    integer n;
    for (n=0; n<8; n=n+1) begin
...
always @(posedge wb_clk) begin: USBP_MYHDL_GPIO1_RTL_WISHBONE_ACK
    if ((!wb_rst)) begin
        g1_ack <= 1'b0;
    end
    else begin
...
always @(posedge wb_clk) begin: USBP_MYHDL_GPIO1_RTL_GPIO_REGISTER_INPUT
...
always @(posedge sys_clk) begin: USBP_MYHDL_RTL_LED_SELECT
    if ((led_sel == 0)) begin
        led <= 85;
    end
    else if ((led_sel == 1)) begin
        led <= led_gpio;
    end
    else if ((led_sel == 2)) begin
        led <= fx2_dbg;
    end
    else begin
        led <= 189;
...
always @(posedge twi0_reset) begin: USBP_MYHDL_TWI0_TXFIFO_RTL_GUARD_BIT
    if (wb_clk) begin
        twi0_txFifo_gb <= 1'b0;
    end
    else begin
        ...
        else if (((twi0_txFifo_wp_p1 == twi0_txFifo_rp) && twi0_tx_fifo_wr)) begin
            twi0_txFifo_gb <= 1'b1;
        end
        else if (twi0_tx_fifo_rd) begin
            twi0_txFifo_gb <= 1'b0;
        end
    end
end

always @(posedge twi0_reset) begin: USBP_MYHDL_TWI0_TXFIFO_RTL_WP_REG
    if (wb_clk) begin
        twi0_txFifo_wp <= 0;
    end
    else begin
...
always @(posedge twi0_reset) begin: USBP_MYHDL_TWI0_TXFIFO_RTL_RP_REG
    if (wb_clk) begin
        twi0_txFifo_rp <= 0;
    end
    else begin
...
always @(posedge twi0_reset) begin: USBP_MYHDL_TWI0_TXFIFO_RTL_MEM
...
always @(twi0_txFifo_rp, twi0_txFifo_gb, twi0_txFifo_wp) begin: USBP_MYHDL_TWI0_TXFIFO_RTL_ASSIGNMENTS
...
always @(posedge twi0_reset) begin: USBP_MYHDL_TWI0_RXFIFO_RTL_GUARD_BIT
    if (wb_clk) begin
        twi0_rxFifo_gb <= 1'b0;
    end
    else begin
        ...
        else if (((twi0_rxFifo_wp_p1 == twi0_rxFifo_rp) && twi0_rx_fifo_wr)) begin
            twi0_rxFifo_gb <= 1'b1;
        end
        else if (twi0_rx_fifo_rd) begin
            twi0_rxFifo_gb <= 1'b0;
        end
    end
end

always @(posedge twi0_reset) begin: USBP_MYHDL_TWI0_RXFIFO_RTL_WP_REG
    if (wb_clk) begin
        twi0_rxFifo_wp <= 0;
    end
    else begin
...
always @(posedge twi0_reset) begin: USBP_MYHDL_TWI0_RXFIFO_RTL_RP_REG
    if (wb_clk) begin
        twi0_rxFifo_rp <= 0;
    end
    else begin
...
always @(posedge twi0_reset) begin: USBP_MYHDL_TWI0_RXFIFO_RTL_MEM
...
always @(twi0_rxFifo_rp, twi0_rxFifo_gb, twi0_rxFifo_wp) begin: USBP_MYHDL_TWI0_RXFIFO_RTL_ASSIGNMENTS
...
always @(posedge wb_clk) begin: USBP_MYHDL_TWI0_REGFILE_RTL_RO_STOBES
...
always @(posedge wb_clk) begin: USBP_MYHDL_TWI0_REGFILE_RTL_WRITE_REG
    if ((!wb_rst)) begin
    ...
    else if ((twi0_regFile__wb_wr && twi0_regFile__wb_sel)) begin
        if ((wb_adr == 0)) begin
            twi0_rwRegisters[0] <= wb_dat_o;
        end
        else if ((wb_adr == 1)) begin
            twi0_rwRegisters[1] <= wb_dat_o;
        end
        else if ((wb_adr == 2)) begin
            twi0_rwRegisters[2] <= wb_dat_o;
        end
        else if ((wb_adr == 3)) begin
            twi0_rwRegisters[3] <= wb_dat_o;
        end
        else if ((wb_adr == 5)) begin
            twi0_rwRegisters[4] <= wb_dat_o;
        end
    end
end

always @(twi0_regFile__wb_sel, twi0_regFile__wb_do) begin: USBP_MYHDL_TWI0_REGFILE_RTL_READ
...
always @(posedge wb_clk) begin: USBP_MYHDL_TWI0_REGFILE_RTL_SELECTED
...
always @(posedge wb_clk) begin: USBP_MYHDL_TWI0_REGFILE_RTL_RW_STOBES
...
always @(posedge wb_clk) begin: USBP_MYHDL_TWI0_REGFILE_RTL_ACK
    if ((!wb_rst)) begin
...
assign wb_dat_i = (g0_dat_i | g1_dat_i | spi_dat_i | twi_dat_i | rmp_dat_i);
assign wb_ack = (g0_ack | g1_ack | spi_ack | twi_ack | rmp_ack);
...
always @(fifo_intf_wb_controller_wb_cmd_reg_sel) begin: USBP_MYHDL_FIFO_INTF_WB_CONTROLLER_WB_CMD_RTL_GO
...
always @(fifo_intf_wb_controller_wb_cmd_reg_sel, fifo_intf_wb_controller_wb_cmd_wb_cmd) begin: USBP_MYHDL_FIFO_INTF_WB_CONTROLLER_WB_CMD_RTL_CONTROL
...
always @(posedge IFCLK) begin: USBP_MYHDL_FIFO_INTF_WB_CONTROLLER_WB_CMD_RTL_MREGS
    if (fifo_intf_ireset) begin
        ...
        if (fifo_intf_wb_fifo_do_vld) begin
            ...
            else if ((fifo_intf_wb_controller_wb_cmd_reg_sel == 1)) begin
                fifo_intf_wb_controller_wb_cmd_sbyte1 <= fifo_intf_wb_fifo_do;
            end
            else if ((fifo_intf_wb_controller_wb_cmd_reg_sel == 2)) begin
                fifo_intf_wb_controller_wb_cmd_wb_cmd <= fifo_intf_wb_fifo_do;
            end
            else if ((fifo_intf_wb_controller_wb_cmd_reg_sel == 3)) begin
                fifo_intf_wb_controller_wb_cmd_addr_hi <= fifo_intf_wb_fifo_do;
            end
            else if ((fifo_intf_wb_controller_wb_cmd_reg_sel == 4)) begin
                fifo_intf_wb_controller_wb_cmd_addr_lo <= fifo_intf_wb_fifo_do;
            end
            else if ((fifo_intf_wb_controller_wb_cmd_reg_sel == 5)) begin
            ...
            else if ((fifo_intf_wb_controller_wb_cmd_reg_sel == 6)) begin
                fifo_intf_wb_controller_wb_cmd_sbyte6 <= fifo_intf_wb_fifo_do;
            end
            else if ((fifo_intf_wb_controller_wb_cmd_reg_sel == 7)) begin
                fifo_intf_wb_controller_wb_cmd_sbyte7 <= fifo_intf_wb_fifo_do;
            end
            else if ((fifo_intf_wb_controller_wb_cmd_reg_sel == 8)) begin
            ...
            if ((fifo_intf_wb_controller_wb_cmd_reg_sel == 8)) begin
                ...
                else if (((fifo_intf_wb_controller_wb_cmd_reg_sel == 3) || (fifo_intf_wb_controller_wb_cmd_reg_sel == 4))) begin
                    fifo_intf_wb_controller_wb_cmd_reg_sel <= (fifo_intf_wb_controller_wb_cmd_reg_sel + 1);
                end
                else if ((fifo_intf_wb_controller_wb_cmd_reg_sel == 5)) begin
                    fifo_intf_wb_controller_wb_cmd_reg_sel <= (fifo_intf_wb_controller_wb_cmd_reg_sel + 1);
...
always @(wb_ack, wb_we, fifo_intf_wb_controller_i_dat_i, fifo_intf_wb_controller_fifo_wr, fifo_intf_wb_fifo_do, fifo_intf_wb_fifo_empty, fifo_intf_wb_fifo_do_vld) begin: USBP_MYHDL_FIFO_INTF_WB_CONTROLLER_RTL2
...
always @(fifo_intf_wb_controller_wb_addr, fifo_intf_wb_controller_wb_ctrl0) begin: USBP_MYHDL_FIFO_INTF_WB_CONTROLLER_RTL6
...
always @(fifo_intf_wb_controller_wb_addr, fifo_intf_wb_controller_wb_go, fifo_intf_wb_controller_wb_wr, fifo_intf_wb_controller_wb_rd) begin: USBP_MYHDL_FIFO_INTF_WB_CONTROLLER_RTL4
    ...
    else if ((fifo_intf_wb_controller_wb_addr[1-1:0] == 1)) begin
        wb_sel <= 2;
    end
    else if ((fifo_intf_wb_controller_wb_addr[1-1:0] == 2)) begin
        wb_sel <= 4;
    end
    else if ((fifo_intf_wb_controller_wb_addr[1-1:0] == 3)) begin
        wb_sel <= 8;
    end
end

always @(posedge IFCLK) begin: USBP_MYHDL_FIFO_INTF_WB_CONTROLLER_RTL5
    if (fifo_intf_ireset) begin
...
always @(posedge IFCLK) begin: USBP_MYHDL_FIFO_INTF_WB_CONTROLLER_RTL3
    if (fifo_intf_ireset) begin
        ...
        if ((FLAGA && (!fifo_intf_wb_fifo_empty) && (!fifo_intf_wb_fifo_full))) begin
            ...
            else if ((fifo_intf_wb_controller_wb_go && wb_stb)) begin
                fifo_intf_wb_controller_fifo_rd <= 1'b1;
                fifo_intf_wb_controller_fifo_wr <= 1'b1;
            end
        end
...
always @(fifo_intf_i_fifo_rd, fifo_intf_ex_fifo_fifoA__rptr_d, fifo_intf_ex_fifo_fifoA__rptr_c) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOA_RTL_RD_POINTER
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOA_RTL_WR
    if (fifo_intf_ireset) begin
        ...
        else if ((fifo_intf_fx2_fifo_wr && (fifo_intf_ex_fifo_fifoA_wptr_p1 == fifo_intf_ex_fifo_fifoA_rptr))) begin
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOA_FMEM_RD_RTL
    fifo_intf_ex_fifo_fifoA_fmem__dout <= fifo_intf_ex_fifo_fifoA_fmem_mem[fifo_intf_ex_fifo_fifoA_rptr];
end

always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOA_FMEM_WR_RTL
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOA_RTL_AE
...
always @(fifo_intf_ex_fifo_fifoA_wptr_p2, fifo_intf_ex_fifo_fifoA_rptr, fifo_intf_ex_fifo_nfulla) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOA_RTL_AF
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOA_RTL_D_RD
    fifo_intf_ex_fifo_fifoA__rd <= fifo_intf_i_fifo_rd;
    fifo_intf_ex_fifo_fifoA__rptr_d <= fifo_intf_ex_fifo_fifoA_rptr;
end

always @(fifo_intf_ex_fifo_fifoA_wptr_p1, fifo_intf_ex_fifo_fifoA_rptr) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOA_RTL_F
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOA_RTL_E
    if ((fifo_intf_ex_fifo_fifoA_rptr == fifo_intf_ex_fifo_fifoA_wptr)) begin
        ...
        else if ((fifo_intf_ex_fifo_fifoA__empty == 1)) begin
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOA_RTL_RD
    if (fifo_intf_ireset) begin
...
always @(fifo_intf_fx2_fifo_rd, fifo_intf_ex_fifo_fifoB__rptr_d, fifo_intf_ex_fifo_fifoB__rptr_c) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOB_RTL_RD_POINTER
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOB_RTL_WR
    if (fifo_intf_ireset) begin
        ...
        else if ((fifo_intf_i_fifo_wr && (fifo_intf_ex_fifo_fifoB_wptr_p1 == fifo_intf_ex_fifo_fifoB_rptr))) begin
            $write("SYNC FIFO DATA DROPPED");
            $write("\n");
        end
    end
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOB_FMEM_RD_RTL
    fifo_intf_ex_fifo_fifoB_fmem__dout <= fifo_intf_ex_fifo_fifoB_fmem_mem[fifo_intf_ex_fifo_fifoB_rptr];
end

always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOB_FMEM_WR_RTL
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOB_RTL_AE
...
always @(fifo_intf_ex_fifo_fifoB_wptr_p2, fifo_intf_ex_fifo_fifoB_rptr, fifo_intf_ex_fifo_nfullb) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOB_RTL_AF
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOB_RTL_D_RD
    fifo_intf_ex_fifo_fifoB__rd <= fifo_intf_fx2_fifo_rd;
    fifo_intf_ex_fifo_fifoB__rptr_d <= fifo_intf_ex_fifo_fifoB_rptr;
end

always @(fifo_intf_ex_fifo_fifoB_wptr_p1, fifo_intf_ex_fifo_fifoB_rptr) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOB_RTL_F
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOB_RTL_E
    if ((fifo_intf_ex_fifo_fifoB_rptr == fifo_intf_ex_fifo_fifoB_wptr)) begin
        ...
        else if ((fifo_intf_ex_fifo_fifoB__empty == 1)) begin
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_EX_FIFO_FIFOB_RTL_RD
    if (fifo_intf_ireset) begin
...
always @(fifo_intf_wb_fifo_wr, FLAGA, fifo_intf_ireset, fifo_intf_wb_cmd_in_prog, fifo_intf_i_fifo_wr, fifo_intf_wb_fifo_empty, fifo_intf_dbg_it, fifo_intf_fx2_wb_empty) begin: USBP_MYHDL_FIFO_INTF_DEBUG_SIGS
...
always @(fifo_intf_wb_fifo_rd, fifo_intf_wb_fifo_fifoA__rptr_d, fifo_intf_wb_fifo_fifoA__rptr_c) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOA_RTL_RD_POINTER
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOA_RTL_WR
    if (fifo_intf_ireset) begin
        ...
        else if ((fifo_intf_fx2_wb_wr && (fifo_intf_wb_fifo_fifoA_wptr_p1 == fifo_intf_wb_fifo_fifoA_rptr))) begin
            $write("SYNC FIFO DATA DROPPED");
            $write("\n");
        end
    end
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOA_FMEM_RD_RTL
    fifo_intf_wb_fifo_fifoA_fmem__dout <= fifo_intf_wb_fifo_fifoA_fmem_mem[fifo_intf_wb_fifo_fifoA_rptr];
end

always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOA_FMEM_WR_RTL
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOA_RTL_AE
...
always @(fifo_intf_wb_fifo_fifoA_wptr_p2, fifo_intf_wb_fifo_fifoA_rptr, fifo_intf_wb_fifo_nfulla) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOA_RTL_AF
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOA_RTL_D_RD
    fifo_intf_wb_fifo_fifoA__rd <= fifo_intf_wb_fifo_rd;
    fifo_intf_wb_fifo_fifoA__rptr_d <= fifo_intf_wb_fifo_fifoA_rptr;
end

always @(fifo_intf_wb_fifo_fifoA_wptr_p1, fifo_intf_wb_fifo_fifoA_rptr) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOA_RTL_F
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOA_RTL_E
    if ((fifo_intf_wb_fifo_fifoA_rptr == fifo_intf_wb_fifo_fifoA_wptr)) begin
        ...
        else if ((fifo_intf_wb_fifo_fifoA__empty == 1)) begin
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOA_RTL_RD
    if (fifo_intf_ireset) begin
...
always @(fifo_intf_fx2_wb_rd, fifo_intf_wb_fifo_fifoB__rptr_d, fifo_intf_wb_fifo_fifoB__rptr_c) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOB_RTL_RD_POINTER
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOB_RTL_WR
    if (fifo_intf_ireset) begin
        ...
        else if ((fifo_intf_wb_fifo_wr && (fifo_intf_wb_fifo_fifoB_wptr_p1 == fifo_intf_wb_fifo_fifoB_rptr))) begin
            $write("SYNC FIFO DATA DROPPED");
            $write("\n");
        end
    end
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOB_FMEM_RD_RTL
    fifo_intf_wb_fifo_fifoB_fmem__dout <= fifo_intf_wb_fifo_fifoB_fmem_mem[fifo_intf_wb_fifo_fifoB_rptr];
end

always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOB_FMEM_WR_RTL
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOB_RTL_AE
...
always @(fifo_intf_wb_fifo_fifoB_wptr_p2, fifo_intf_wb_fifo_fifoB_rptr, fifo_intf_wb_fifo_nfullb) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOB_RTL_AF
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOB_RTL_D_RD
    fifo_intf_wb_fifo_fifoB__rd <= fifo_intf_fx2_wb_rd;
    fifo_intf_wb_fifo_fifoB__rptr_d <= fifo_intf_wb_fifo_fifoB_rptr;
end

always @(fifo_intf_wb_fifo_fifoB_wptr_p1, fifo_intf_wb_fifo_fifoB_rptr) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOB_RTL_F
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOB_RTL_E
    if ((fifo_intf_wb_fifo_fifoB_rptr == fifo_intf_wb_fifo_fifoB_wptr)) begin
        ...
        else if ((fifo_intf_wb_fifo_fifoB__empty == 1)) begin
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_WB_FIFO_FIFOB_RTL_RD
    if (fifo_intf_ireset) begin
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_RTL2
    if (reset) begin
...
always @(fifo_intf_i_fifo_empty, fifo_intf_lp_fifo_wr, fifo_intf_lp_fifo_di, loopback, fifo_wr, fifo_intf_lp_fifo_rd, fifo_intf_i_fifo_full, fifo_intf_i_fifo_do, fifo_rd, fifo_intf_i_fifo_do_vld, fifo_di) begin: USBP_MYHDL_FIFO_INTF_RTL3
    if (loopback) begin
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_RTL1
    if (reset) begin
...
always @(posedge IFCLK) begin: USBP_MYHDL_FIFO_INTF_RTL5
    if (fifo_intf_ireset) begin
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_DGB_IT_RTL
    if (reset) begin
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_FX2_RTL_BUS_WR
    if (reset) begin
...
always @(fifo_intf_fx2_arb_state) begin: USBP_MYHDL_FIFO_INTF_FX2_ARB_RTL3
...
always @(fifo_intf_fx2_arb_state) begin: USBP_MYHDL_FIFO_INTF_FX2_ARB_RTL2
    ...
    else if (((fifo_intf_fx2_arb_state == 4'b1010) || (fifo_intf_fx2_arb_state == 4'b1011) || (fifo_intf_fx2_arb_state == 4'b1100) || (fifo_intf_fx2_arb_state == 4'b1101))) begin
        fifo_intf_fx2__fifoadr <= 3;
    end
    else if (((fifo_intf_fx2_arb_state == 4'b0001) || (fifo_intf_fx2_arb_state == 4'b0010) || (fifo_intf_fx2_arb_state == 4'b0011))) begin
        fifo_intf_fx2__fifoadr <= 0;
    end
    else if (((fifo_intf_fx2_arb_state == 4'b0111) || (fifo_intf_fx2_arb_state == 4'b1000) || (fifo_intf_fx2_arb_state == 4'b1001))) begin
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_FX2_ARB_RTL1
    if (reset) begin
        fifo_intf_fx2_arb_state <= 4'b0000;
    end
    else begin
        // synthesis parallel_case full_case
        casez (fifo_intf_fx2_arb_state)
            4'b0000: begin
                if (((!fifo_intf_fx2_ep2_empty) && (!fifo_intf_fx2_wb_full))) begin
                    fifo_intf_fx2_arb_state <= 4'b0001;
                end
                else if (((!fifo_intf_fx2_wb_empty) && (!fifo_intf_fx2_ep6_full) && (!fifo_intf_wb_cmd_in_prog))) begin
                    fifo_intf_fx2_arb_state <= 4'b0111;
                end
                else if (((!fifo_intf_fx2_ep4_empty) && (!fifo_intf_fx2_fifo_full))) begin
                    fifo_intf_fx2_arb_state <= 4'b0100;
                end
                else if (((!fifo_intf_fx2_fifo_empty) && (!fifo_hold) && (!fifo_intf_fx2_ep8_full))) begin
            ...
            4'b1011: begin
                ...
                else if (fifo_intf_fx2_ep8_full) begin
...
always @(posedge sys_clk) begin: USBP_MYHDL_FIFO_INTF_FX2_RTL_DATA_WR
    if (reset) begin
        ...
        else if ((fifo_intf_fx2__fifo_wr && fifo_intf_fx2_fifo_full)) begin
            fifo_intf_fx2__fifo_wr <= 1'b0;
        end
        else begin
            fifo_intf_fx2__fifo_wr <= 1'b0;
...
always @(posedge wb_clk) begin: USBP_MYHDL_RMP0_RTL_RAMP
    if ((!wb_rst)) begin
        rmp0_ramp <= 0;
        fifo_wr_rmp <= 1'b0;
        fifo_di_rmp <= 0;
...
always @(posedge wb_clk) begin: USBP_MYHDL_RMP0_REGFILE_RTL_WRITE_REG
    if ((!wb_rst)) begin
        rmp0_rwRegisters[0] <= 0;
    end
    else if ((rmp0_regFile__wb_wr && rmp0_regFile__wb_sel)) begin
...
always @(rmp0_regFile__wb_sel, rmp0_regFile__wb_do) begin: USBP_MYHDL_RMP0_REGFILE_RTL_READ
...
always @(posedge wb_clk) begin: USBP_MYHDL_RMP0_REGFILE_RTL_READ_REG
    if ((wb_adr == (0 + 2048))) begin
        rmp0_regFile__wb_do <= rmp0_rwRegisters[0];
    end
end

always @(posedge wb_clk) begin: USBP_MYHDL_RMP0_REGFILE_RTL_SELECTED
...
always @(posedge wb_clk) begin: USBP_MYHDL_RMP0_REGFILE_RTL_RW_STOBES
...
always @(posedge wb_clk) begin: USBP_MYHDL_RMP0_REGFILE_RTL_ACK
    if ((!wb_rst)) begin
...
assign fifo_wr = (fifo_wr_spi | fifo_wr_twi | fifo_wr_rmp);
assign fifo_rd = (fifo_rd_spi | fifo_rd_twi | fifo_rd_rmp);
assign fifo_di = (fifo_di_spi | fifo_di_twi | fifo_di_rmp);
