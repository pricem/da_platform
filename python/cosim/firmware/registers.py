...
#   PCM4202
        {'target': 'PCM4202 2-channel ADC',
         'registers': {
                'FMT': {'address': 0, 'bit_min': 0, 'bit_max': 1, 'description': 'Audio data format', 'choices': [(0b00, 'PCM left-justified 24-bit'), (0b01, 'PCM I2S 24-bit'), (0b10, 'PCM standard 24-bit'), (0b11, 'DSD')], 'help': None},
                'SM': {'address': 0, 'bit_min': 2, 'bit_max': 2, 'description': 'Audio data master/slave', 'choices': [(0b0, 'Master'), (0b1, 'Slave')], 'help': 'Master recommended for timing simplicity'},
                'FS': {'address': 0, 'bit_min': 3, 'bit_max': 5, 'description': 'Oversampling and clk/Fs ratios', 'choices': [(0b000, '1x clk=768Fs'), (0b001, '1x clk=512Fs'), (0b010, '1x clk=384Fs'), (0b011, '1x clk=256Fs'), (0b100, '2x clk=384Fs'), (0b101, '2x clk=256Fs'), (0b110, '4x clk=192Fs'), (0b111, '4x clk=128Fs')], 'help': 'Use one of first 3 choices in slave mode; \nuse 0b101 in DSD mode'},
                'HPFD': {'address': 0, 'bit_min': 6, 'bit_max': 6, 'description': 'High-pass filter', 'choices': [(0b0, 'Enabled'), (0b1, 'Disabled')], 'help': '-3 dB at 1 Hz'},
            }
        }
    ]

""" Settings for I/O modules.
    These consist of a subset of the converter chip's registers (or hardware configuration pins)
    that are relevant to conversion, as well as other settings relevant to conversion.  Those are especially
         ...
         'registers':
            {
                ...
                #   Format register - these match the hardware registers
...
#   PCM4202
        {'target': 'PCM4202 2-channel ADC',
         'registers': {
                #   A valuable quantity that is necessary to determine the relationship between other registers
                'CLKT': {'address': 0, 'bit_min': 0, 'bit_max': 0, 'description': 'Clock domain', 'choices': [(0b0, '44.1 kHz'), (0b1, '48 kHz')]},
                #   From hardware configuration
                'FMT': {'address': 0, 'bit_min': 1, 'bit_max': 2},      #   (2) 00 = PCM left justified, 01 = PCM I2S, 10 = PCM right justified, 11 = DSD
                'SM': {'address': 0, 'bit_min': 3, 'bit_max': 3},       #   (1) 0 = Master, 1 = Slave
                'FS': {'address': 0, 'bit_min': 4, 'bit_max': 6},       #   (3) 0-3 = 1x at 768, 512, 384, 256x Fs; 4-5 = 2x at 384, 256x Fs; 6-7 = 4x at 192, 128x Fs.
                                                                        #       In DSD mode, 4 = 384x Fs and 5 = 256x Fs (you want 256x and 44.1 kHz clock domain)
            }
        },
...
#   AD1934
        {'target': 'AD1934 8-channel DAC',
         'registers': {
                ...
                'BM': {'address': 2, 'bit_min': 4, 'bit_max': 4},       #   (1) 0 = slave, 1 = master BCLK
                'BS': {'address': 2, 'bit_min': 5, 'bit_max': 5},       #   (1) 0 = external, 1 = internal BCLK source
                'BP': {'address': 2, 'bit_min': 6, 'bit_max': 6},       #   (1) 0 = normal, 1 = inverted BCLK polarity
...
#   AD1974 
        {'target': 'AD1974 8-channel ADC',
         'registers': {
                ...
                'BS': {'address': 2, 'bit_min': 5, 'bit_max': 5},       #   (1) 0 = external, 1 = internal BCLK source
                'BP': {'address': 2, 'bit_min': 6, 'bit_max': 6},       #   (1) 0 = normal, 1 = inverted BCLK polarity
                'LRF': {'address': 2, 'bit_min': 7, 'bit_max': 7},      #   (1) 0 = 50/50, 1 = pulse (32-BCLK only) LRCLK format
            }
        },
    ]
