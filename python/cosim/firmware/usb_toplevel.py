...
def usb_toplevel(
    ...
    dependencies = [module_name, 'dut_' + module_name, 'tracking_fifo', 'memory_arbitrator', 'fx2_interface', 'bram_2k_8', 'dummy_dac', 'dummy_adc', 'bram_8m_16', 'cellram', 'delay_reg', 'dac_pmod', 'controller', 'deserializer', 'serializer', 'spi_controller']
    ...
    slot_data_in=slot_data_in, slot_data_out=slot_data_out, custom_dirchan=custom_dirchan, spi_adc_cs=spi_adc_cs, spi_adc_mclk=spi_adc_mclk, spi_adc_mdi=spi_adc_mdi, spi_adc_mdo=spi_adc_mdo, spi_dac_cs=spi_dac_cs, spi_dac_mclk=spi_dac_mclk, spi_dac_mdi=spi_dac_mdi, spi_dac_mdo=spi_dac_mdo, custom_adc_hwcon=custom_adc_hwcon, custom_adc_ovf=custom_adc_ovf, custom_clk0=custom_clk0, custom_srclk=custom_srclk, custom_clksel=custom_clksel, custom_clk1=custom_clk1,
    reset=reset, clk=clk)
