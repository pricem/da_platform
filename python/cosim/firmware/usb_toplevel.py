...
def usb_toplevel(
    ...
    dependencies = [module_name, 'dut_' + module_name, 'tracking_fifo', 'memory_arbitrator', 'fx2_interface', 'bram_2k_8', 'dummy_dac', 'dummy_adc', 'bram_8m_16', 'cellram', 'delay_reg', 'dac_pmod', 'controller', 'deserializer', 'serializer']
