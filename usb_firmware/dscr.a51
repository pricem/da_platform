...
;;;-----------------------------------------------------------------------------
;;; Modified by Michael Price 6/13/2010
;;; CD player USB firmware
;;;-----------------------------------------------------------------------------

        .module usb_descriptors

        VID              = 0x0144         ; Vendor ID 
        PID              = 0x0281         ; Product ID
        VERSION          = 0x0004         ; Product Version (4 indicates *BM device) 
        USB_VER          = 0x0110         ; Support USB version
        ...
        MAX_POWER        = 100            ; desired current from USB host
...
_full_speed_config_descr::        
        ...
        .db        DSCR_ENDPNT_LEN
        .db        DSCR_ENDPNT
        .db        0x01             ; bEndpointAddress (ep 1 OUT)
        .db        ET_BULK          ; bmAttributes
